...
impl<T: Config> LiquidityPool<T> {
    ...
    pub fn mint(
        &mut self,
        amounts_in: (AssetBalanceOf<T>, AssetBalanceOf<T>),
    ...
    pub fn swap(
        ...
        // Check that this is the right pool for doing this swap
        ensure!(
        ...
        // Reserves are how many tokens are in the pool (2 tokens)
    ...
    fn get_amount_out(
        ...
        // Calculate the input amount (after subtracting the swap fee (0.3%)) by multiplying by 997 (99.7%)
